...
@RestController
@RequestMapping("/api/das-kafka")
public class DasKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DasKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DasKafkaResource(KafkaProperties kafkaProperties) {
